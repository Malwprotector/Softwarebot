...
async def info(ctx):
    ...
    await ctx.send('**`SoftwareBot version 1.2 made by Lushketchup8624, coded in python3,  discord server server_name | View code on github:`** https://github.com/Malwprotector/Softwarebot') #text that is sent by the bot
